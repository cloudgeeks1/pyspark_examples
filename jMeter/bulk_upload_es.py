...
elastic = OpenSearch("https://search-rp-rta-dev-bo6fjjyiodpgvjx5urkggd3xgi.us-east-1.es.amazonaws.com")
...
try:
    ...
    response = helpers.bulk(elastic, bulk_json_data("wikidata_type_dict.json", "my-index-000003", "twitter"))
...
#     response = helpers.bulk(elastic, actions, index='my-index-000003', doc_type='twitter')
